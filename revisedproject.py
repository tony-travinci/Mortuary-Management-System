...
DateEntryLogin = Entry(LoginFrameRight, width=10, bg='Green', textvariable=Date1, font=('times', 20, 'italic'),
                       fg='white',
                       relief='ridge', bd=2)
...
TopLabelLogin = Label(LoginFrameLeft, text="Egerton University Funeral Home Management System",
...
LoginButton = Button(LoginFrameLeft, width=10, height=2, text="Log In", bg='Green', command=authentication, fg='white',
                     font=('times', 14, 'italic'), relief='ridge')
...
RegisterBodyButton = Button(MenuFrameBottomLeft, text="Register Body", height=2, width=20, relief='ridge', bd=2,
                            fg='green', command=registrationpage, bg='white', font=('times', 14, 'italic'))
RegisterBodyButton.place(x=50, y=250)

ViewRecordsButton = Button(MenuFrameBottomLeft, text="View Records", height=2, width=20, relief='ridge', bd=2,
                           fg='green', bg='white', font=('times', 14, 'italic'))
ViewRecordsButton.place(x=50, y=450)

BillBodyButton = Button(MenuFrameBottomLeft, text="Bill Body", height=2, width=20, relief='ridge', bd=2, fg='green',
                        bg='white', font=('times', 14, 'italic'))
BillBodyButton.place(x=50, y=650)

AdditionalChargesButton = Button(MenuFrameBottomLeft, text="Additional Charges", height=2, width=20, relief='ridge',
                                 bd=2, fg='green', bg='white', font=('times', 14, 'italic'))
AdditionalChargesButton.place(x=350, y=250)

PenaltiesButton = Button(MenuFrameBottomLeft, text="Penalties", relief='ridge', height=2, width=20, bd=2, fg='green',
                         bg='white', font=('times', 14, 'italic'))
PenaltiesButton.place(x=350, y=450)

CoffinDescriptionButton = Button(MenuFrameBottomLeft, text="Coffin Description", relief='ridge', height=2, width=20,
                                 bd=2, fg='green', bg='white', font=('times', 14, 'italic'))
CoffinDescriptionButton.place(x=350, y=650)

FlowerTypesButton = Button(MenuFrameBottomLeft, text="Flower Types", height=2, width=20, relief='ridge', bd=2,
                           fg='green', bg='white', font=('times', 14, 'italic'))
FlowerTypesButton.place(x=650, y=250)

PackageDescriptionButton = Button(MenuFrameBottomLeft, text="Package Types", relief='ridge', height=2, width=20, bd=2,
                                  fg='green', bg='white', font=('times', 14, 'italic'))
PackageDescriptionButton.place(x=650, y=450)

AboutButton = Button(MenuFrameBottomLeft, text="About", relief='ridge', height=2, width=20, bd=2, fg='green',
                     bg='white', font=('times', 14, 'italic'))
...
RegistrationLabel = Label(RegistrationFrameLeft, text="Body Registration", font=('times', 14, 'italic'), bd=2,
                          relief='ridge', bg='green', fg='white')
...
AddressLabel = Label(RegistrationFrameLeft, text="Physcial Address", font=('times', 14, 'italic'), fg='white',
                     bg='green')
...
OptionsRegistrationButton = Button(RegistrationFrameRight, text="Back To Options", bd=2, font=('times', 14, 'italic'),
                                   relief='ridge', bg='green', fg='white', height=2, width=15)
OptionsRegistrationButton.place(x=100, y=500)

NextRegistrationButton = Button(RegistrationFrameRight, text="Next", bd=2, font=('times', 14, 'italic'), relief='ridge',
                                command=selecttype, bg='green', fg='white', height=2, width=15)
...
SelectPackageLabel = Label(SelectFrameLeft, text="Choose either a Comprehesive Package or cutomize your own package",
                           font=('times', 14, 'italic'), bg='Green', fg='white')
SelectPackageLabel.place(x=50, y=250)

ButtonPackages = Button(SelectFrameLeft, width=50, height=5, text="Select Comprehensive Package",
                        font=('times', 14, 'italic'), command=comppackage, bg='Green', relief='ridge', fg="white", bd=2)
ButtonPackages.place(x=280, y=300)

ButtonCustomize = Button(SelectFrameLeft, width=50, height=5, text="Customize Package", font=('times', 14, 'italic'),
                         command=coffinselect, bg='Green', relief='ridge', fg="white", bd=2)
...
MainCheckLabel = Label(ServicesFrameLeft, text='Remains of 10 years and Above', font=('times', 16, 'italic'),
                       bg='green', fg='white')
MainCheckLabel.place(x=10, y=50)

BodyWashingLabel = Label(ServicesFrameLeft, text='Body admission and Preservation process',
                         font=('times', 12, 'italic'), bg='green', fg='white')
...
CustodyLabel = Label(ServicesFrameLeft, text='Daily Custodial Care and Storage', font=('times', 12, 'italic'),
                     bg='green', fg='white')
...
FinalGroomingLabel = Label(ServicesFrameLeft, text='Final Grooming and Dispatch', font=('times', 12, 'italic'),
                           bg='green', fg='white')
...
AncillaryLabel = Label(ServicesFrameLeft, text='Ancillary Services', font=('times', 16, 'italic'), bg='green',
                       fg='white')
AncillaryLabel.place(x=0, y=170)

PostMortemLabel = Label(ServicesFrameLeft, text='Post Mortem Cases', font=('times', 16, 'italic'), bg='green',
                        fg='white')
PostMortemLabel.place(x=0, y=200)

PostMortemSuitLabel = Label(ServicesFrameLeft, text='Post Mortem Suit', font=('times', 12, 'italic'), bg='green',
                            fg='white')
...
PostMortemAutopsyLabel = Label(ServicesFrameLeft, text='Post Autopsy Care', font=('times', 12, 'italic'), bg='green',
                               fg='white')
...
PostMortemSamplesLabel = Label(ServicesFrameLeft, text='Samples Recovery and Preservation',
                               font=('times', 12, 'italic'), bg='green', fg='white')
...
PostMortemDailyLabel = Label(ServicesFrameLeft, text='Daily Care Before Pm', font=('times', 12, 'italic'), bg='green',
                             fg='white')
...
TransferLabel = Label(ServicesFrameLeft, text='Transfer From Other Facilities', font=('times', 16, 'italic'),
                      bg='green', fg='white')
TransferLabel.place(x=0, y=380)

CustodialTransferLabel = Label(ServicesFrameLeft, text='Custodial Care only less 4 days stay',
                               font=('times', 12, 'italic'), bg='green', fg='white')
...
ExtraDaysPreservationLabel = Label(ServicesFrameLeft, text='For Preservation and after care less 4 days stay',
                                   font=('times', 12, 'italic'), bg='green', fg='white')
...
OvernightLabel = Label(ServicesFrameLeft, text='Body On Transit Overnight Stay', font=('times', 12, 'italic'),
                       bg='green', fg='white')
...
SeveralPMLabel = Label(ServicesFrameLeft, text='Bodies with several Post Mortem Changes', font=('times', 16, 'italic'),
                       bg='green', fg='white')
SeveralPMLabel.place(x=0, y=530)

AdmitPMLabel = Label(ServicesFrameLeft, text='Body Admission and Preservation Process', font=('times', 12, 'italic'),
                     bg='green', fg='white')
...
CustodyPMLabel = Label(ServicesFrameLeft, text='Daily Custodial Care And Storage', font=('times', 12, 'italic'),
                       bg='green', fg='white')
...
GroomPMLabel = Label(ServicesFrameLeft, text='Final Grooming and Dispatch', font=('times', 12, 'italic'), bg='green',
                     fg='white')
...
BackButtonCoffin = Button(ServicesFrameLeft, text="Back", font=('times', 14, 'italic'), bg='green', width=15,
                          fg='white', relief='ridge', bd=2)
...
Chkbtn11 = Checkbutton(ServicesFrameLeft, offvalue=0, onvalue=1, variable=TransferPreservation, command=cmdc,
                       bg='green')
...
MainChildLabel = Label(ServicesFrameRight, text='Remains of Below 10 Years', font=('times', 16, 'italic'), bg='green',
                       fg='white')
...
BodyWashingChildLabel = Label(ServicesFrameRight, text='Body admission and Preservation process',
                              font=('times', 12, 'italic'), bg='green', fg='white')
...
CustodyChildLabel = Label(ServicesFrameRight, text='Daily Custodial Care and Storage', font=('times', 12, 'italic'),
                          bg='green', fg='white')
...
FinalChildGroomingLabel = Label(ServicesFrameRight, text='Final Grooming and Dispatch', font=('times', 12, 'italic'),
                                bg='green', fg='white')
...
AncillaryChildLabel = Label(ServicesFrameRight, text='Ancillary Services', font=('times', 16, 'italic'), bg='green',
                            fg='white')
AncillaryChildLabel.place(x=0, y=170)

PostMortemChildLabel = Label(ServicesFrameRight, text='Post Mortem Cases', font=('times', 16, 'italic'), bg='green',
                             fg='white')
PostMortemChildLabel.place(x=0, y=200)

PostMortemSuitChildLabel = Label(ServicesFrameRight, text='Post Mortem Suit', font=('times', 12, 'italic'), bg='green',
                                 fg='white')
...
PostMortemAutopsyChildLabel = Label(ServicesFrameRight, text='Post Autopsy Care', font=('times', 12, 'italic'),
                                    bg='green', fg='white')
...
PostMortemSamplesChildLabel = Label(ServicesFrameRight, text='Samples Recovery and Preservation',
                                    font=('times', 12, 'italic'), bg='green', fg='white')
...
PostMortemDailyChildLabel = Label(ServicesFrameRight, text='Daily Care Before Pm', font=('times', 12, 'italic'),
                                  bg='green', fg='white')
...
ExhumationChildLabel = Label(ServicesFrameRight, text='Exhumation', font=('times', 12, 'italic'), bg='green',
                             fg='white')
...
TransferChildLabel = Label(ServicesFrameRight, text='Transfer From Other Facilities', font=('times', 16, 'italic'),
                           bg='green', fg='white')
TransferChildLabel.place(x=0, y=380)

CustodialChildTransferLabel = Label(ServicesFrameRight, text='Custodial Care only less 4 days stay',
                                    font=('times', 12, 'italic'), bg='green', fg='white')
...
ExtraChildDaysPreservationLabel = Label(ServicesFrameRight, text='For Preservation and after care less 4 days stay',
                                        font=('times', 12, 'italic'), bg='green', fg='white')
...
OvernightChildLabel = Label(ServicesFrameRight, text='Body On Transit Overnight Stay', font=('times', 12, 'italic'),
                            bg='green', fg='white')
...
SeveralPMChildLabel = Label(ServicesFrameRight, text='Bodies with several Post Mortem Changes',
                            font=('times', 16, 'italic'), bg='green', fg='white')
SeveralPMChildLabel.place(x=0, y=530)

AdmitPMChildLabel = Label(ServicesFrameRight, text='Body Admission and Preservation Process',
                          font=('times', 12, 'italic'), bg='green', fg='white')
...
CustodyPMChildLabel = Label(ServicesFrameRight, text='Daily Custodial Care And Storage', font=('times', 12, 'italic'),
                            bg='green', fg='white')
...
GroomPMChildLabel = Label(ServicesFrameRight, text='Final Grooming and Dispatch', font=('times', 12, 'italic'),
                          bg='green', fg='white')
...
NextButtonCoffin = Button(ServicesFrameRight, text="Next", font=('times', 14, 'italic'), bg='green',
                          command=flowerselect, width=15, fg='white', relief='ridge', bd=2)
...
Chkbtn1Child = Checkbutton(ServicesFrameRight, offvalue=0, onvalue=1, variable=BodyAdmitChild, command=cmdChild,
                           bg='green')
Chkbtn1Child.place(x=20, y=80)

Chkbtn2Child = Checkbutton(ServicesFrameRight, offvalue=0, onvalue=1, variable=DailyCareChild, command=cmdChild,
                           bg='green')
Chkbtn2Child.place(x=20, y=110)

Chkbtn3Child = Checkbutton(ServicesFrameRight, offvalue=0, onvalue=1, variable=GroomingChild, command=cmdChild,
                           bg='green')
Chkbtn3Child.place(x=20, y=140)

Chkbtn4Child = Checkbutton(ServicesFrameRight, offvalue=0, onvalue=1, variable=PMSuitChild, command=cmdChild,
                           bg='green')
Chkbtn4Child.place(x=20, y=230)

Chkbtn5Child = Checkbutton(ServicesFrameRight, offvalue=0, onvalue=1, variable=PMCareChild, command=cmdChild,
                           bg='green')
Chkbtn5Child.place(x=20, y=260)

Chkbtn6Child = Checkbutton(ServicesFrameRight, offvalue=0, onvalue=1, variable=SampleCareChild, command=cmdChild,
                           bg='green')
Chkbtn6Child.place(x=20, y=290)

Chkbtn7Child = Checkbutton(ServicesFrameRight, offvalue=0, onvalue=1, variable=DailyPMCareChild, command=cmdChild,
                           bg='green')
Chkbtn7Child.place(x=20, y=320)

Chkbtn8Child = Checkbutton(ServicesFrameRight, offvalue=0, onvalue=1, variable=ExhumationChild, command=cmdChild,
                           bg='green')
Chkbtn8Child.place(x=20, y=350)

Chkbtn9Child = Checkbutton(ServicesFrameRight, offvalue=0, onvalue=1, variable=TransferChild, command=cmdChild,
                           bg='green')
Chkbtn9Child.place(x=20, y=410)

Chkbtn10Child = Checkbutton(ServicesFrameRight, offvalue=0, onvalue=1, variable=TransferDaysChild, command=cmdChild,
                            bg='green')
Chkbtn10Child.place(x=20, y=440)

Chkbtn11Child = Checkbutton(ServicesFrameRight, offvalue=0, onvalue=1, variable=TransferPreservationChild,
                            command=cmdChild, bg='green')
Chkbtn11Child.place(x=20, y=470)

Chkbtn12Child = Checkbutton(ServicesFrameRight, offvalue=0, onvalue=1, variable=TransitChild, command=cmdChild,
                            bg='green')
Chkbtn12Child.place(x=20, y=500)

Chkbtn13Child = Checkbutton(ServicesFrameRight, offvalue=0, onvalue=1, variable=BodyAPMAdmissionChild, command=cmdChild,
                            bg='green')
Chkbtn13Child.place(x=20, y=560)

Chkbtn14Child = Checkbutton(ServicesFrameRight, offvalue=0, onvalue=1, variable=BodyAPMCustodyChild, command=cmdChild,
                            bg='green')
Chkbtn14Child.place(x=20, y=590)

Chkbtn15Child = Checkbutton(ServicesFrameRight, offvalue=0, onvalue=1, variable=BodyAPMGroomingChild, command=cmdChild,
                            bg='green')
...
SmallBouquetSelectLabel = Label(MauaFrameLeft, text='Small Size Bouquet', font=('times', 12, 'italic'), bg='green',
                                fg='white')
...
MediumBouquetSelectLabel = Label(MauaFrameLeft, text='Medium Size Bouquet', font=('times', 12, 'italic'), bg='green',
                                 fg='white')
...
BigBouquetSelectLabel = Label(MauaFrameLeft, text='Big Size Bouquet', font=('times', 12, 'italic'), bg='green',
                              fg='white')
...
MauaNextButton = Button(MauaFrameRight, text="Next", relief='ridge', bd=2, bg='Green', fg='white', height=3,
                        command=eulogy, width=30)
...
A3OneSelectLabel = Label(FlowerFrameLeft, text='A 3 One Page Colour', font=('times', 12, 'italic'), bg='green',
                         fg='white')
...
A3TwoSelectLabel = Label(FlowerFrameLeft, text='A 3 Two Page Colour', font=('times', 12, 'italic'), bg='green',
                         fg='white')
...
A4OneSelectLabel = Label(FlowerFrameLeft, text='A 4 One Page Colour', font=('times', 12, 'italic'), bg='green',
                         fg='white')
...
A4TwoSelectLabel = Label(FlowerFrameLeft, text='A 4 Two Page Colour', font=('times', 12, 'italic'), bg='green',
                         fg='white')
...
BackFinalButton = Button(FlowerFrameRight, text="Back", relief='ridge', bd=2, bg='Green', fg='white', height=3,
                         width=20, font=('times', 14, 'italic'))
BackFinalButton.place(x=80, y=450)

SubmitFinalButton = Button(FlowerFrameRight, text="Submit", relief='ridge', bd=2, bg='Green', fg='white', height=3,
                           width=20, font=('times', 14, 'italic'))
...
StandardDPBrownSelectLabel = Label(CoffinFrameLeft, text='Standard Dp Brown', font=('times', 12, 'italic'), bg='green',
                                   fg='white')
...
StandardDPWhiteSelectLabel = Label(CoffinFrameLeft, text='Standard Dp White', font=('times', 12, 'italic'), bg='green',
                                   fg='white')
...
StandardGGBrownSelectLabel = Label(CoffinFrameLeft, text='Standard GG Brown', font=('times', 12, 'italic'), bg='green',
                                   fg='white')
...
StandardGGWhiteSelectLabel = Label(CoffinFrameLeft, text='Standard GG White', font=('times', 12, 'italic'), bg='green',
                                   fg='white')
...
ExecutiveChocolateBrownSelectLabel = Label(CoffinFrameLeft, text='Executive Brown and Chocolate',
                                           font=('times', 12, 'italic'), bg='green', fg='white')
...
ExecutiveIvoryWhiteSelectLabel = Label(CoffinFrameLeft, text='Executive Ivory White', font=('times', 12, 'italic'),
                                       bg='green', fg='white')
...
BronzeSelectLabel = Label(CoffinFrameRight, text='Bronze Send Off', font=('times', 12, 'italic'), bg='green',
                          fg='white')
...
SilverSelectLabel = Label(CoffinFrameRight, text='Silver Send Off', font=('times', 12, 'italic'), bg='green',
                          fg='white')
...
BourneSupremacySelectLabel = Label(CoffinFrameRight, text='Bourne Supremacy', font=('times', 12, 'italic'), bg='green',
                                   fg='white')
...
Chkbtn5Select = Checkbutton(CoffinFrameLeft, offvalue=0, onvalue=1, variable=ExecutiveChocolateBrown, command=comm,
                            bg='green')
Chkbtn5Select.place(x=20, y=400)

Chkbtn6Select = Checkbutton(CoffinFrameLeft, offvalue=0, onvalue=1, variable=ExecutiveIvoryWhite, command=comm,
                            bg='green')
...
Chkbtn15Select = Checkbutton(CoffinFrameRight, offvalue=0, onvalue=1, variable=BourneSupremacy, command=comm,
                             bg='green')
...
SubmitPackageButton = Button(CoffinFrameRight, text="Submit", bd=2, bg='Green', font=('times', 14, 'italic'),
